...
<head>
   ...
   <style type="text/css">
        ...
        h2{color: limegreen; font-size: 24pt;}
        label{color: yellow;}
...
<body>
    ...
    <hr>
    <p>You are connected to the Project 4 Enterprise System database as a <span style = "color: red;">root-level</span> user. <br>Please enter any SQL query or update command in the box below.</p>
    <br>
   <form action = "/Project-4/rootHome" method = "post">
